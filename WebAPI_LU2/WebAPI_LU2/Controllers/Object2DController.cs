...
using WebAPI_LU2.Repositories;
using WebAPI_LU2.Services;

namespace WebAPI_LU2.Controllers;
...
public class Object2DController : ControllerBase
{
    ...
    [HttpGet("{environment2DId}", Name = "GetObject2DByEnvironment2D")]
    public async Task<ActionResult<List<Object2D>>> GetByEnvironment2DAsync(Guid environment2DId)
    {
        var object2D = await _object2DRepository.SelectByEnvironmentAsync(environment2DId);
    ...
    public async Task<ActionResult<Object2D>> AddAsync(Object2D object2D)
    {
        ...
        return CreatedAtRoute("GetObject2DByEnvironment2D", new { environment2DId = object2D.Environment2DId }, object2D);
    }
